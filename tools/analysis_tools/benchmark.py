...
def parse_args():
    ...
    parser.add_argument('--config', default='/home/zh/wzt_all/wzt-fgd/CrossKD-master/work-dir-mfl/retinanet/crkd-srd/r101-50-1/crosskd+srd_r101_retinanet_r50_fpn_2x_coco.py', help='test config file path')
    parser.add_argument('--checkpoint', default='/home/zh/wzt_all/wzt-fgd/CrossKD-master/work-dir-mfl/retinanet/crkd-srd/r101-50-1/epoch_19_98.9.pth',help='checkpoint file')
    parser.add_argument(
        '--task',
